...
from drivers.waveshare.lib.waveshare_epd.epdsoftware import EPD as EPDSOFTWARE
...
class Waveshare(Display):
    ...
    def generateEpd(self, model: str) -> EPDBase:
        match model.lower():
            case "epd2in13v4":
                try:
                    from drivers.waveshare.lib.waveshare_epd.epd2in13_V4 import EPD as EPD2IN13V4
